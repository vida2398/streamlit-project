...
- 뉴스 데이터를 기반으로 **과의존 위험군의 특징** 확인
- 연령대별 스마트폰 의존도 분석
- **콘텐츠 유형별 트래픽 현황** 분석
- 실업률과 스마트폰 의존도의 연관성 분석
- **디지털 디톡스** 실천을 위한 생활 팁 제시
- 전국 스마트 쉼 센터 위치 및 정보 안내

프로젝트는 **Python, Streamlit, Plotly, Folium**을 활용하여 시각화와 대화형 분석을 구현했습니다.
...
| **데이터 분석 내용** | **1. 과의존 위험도 분석:** 연령대별 의존도 추이와 실업률 데이터를 비교하며, 과의존 심화 시기(2021년 등)의 주요 외부 요인을 탐색합니다.<br><br>**2. 콘텐츠 이용 현황 분석:** 콘텐츠 유형별 트래픽 점유율을 분석하여, 과의존 이용자가 주로 접하는 주요 콘텐츠 유형을 파악하고 뉴스 자료와 비교합니다. |
